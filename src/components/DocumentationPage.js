            ...
            <div className="content-wrapper">
                ...
                <div className="container docs-wrapper main-content">
                    <article>
                        ...
                        <p className="text">
                            <strong>Base url:</strong><a className="link link_text" href="https://the-dark-api-client.herokuapp.com/api" target={"_blank"}>https://the-dark-api-client.herokuapp.com/api</a>
                        </p>
                        <p className="text">
